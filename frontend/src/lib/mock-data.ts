...
// Training Lab mock data
export const mockExperiments: import("./types").Experiment[] = [
  {
    id: "exp-001",
    user_name: "joe",
    experiment_type: "hyperparameter_sweep",
    name: "XGBoost depth sweep (mock)",
    description: "Sweeping max_depth from 2-10 on synthetic data",
    parameters: { "xgboost.max_depth": { min: 2, max: 10, step: 1 } },
    results: { win_rate: 0.64, sharpe_ratio: 1.12, max_drawdown: 0.15 },
    notes: "Depth 6 looks optimal for mock data",
    status: "completed",
    phase: "pre_server",
    data_source: "mock",
    mlflow_run_id: null,
  ...
  },
  {
    id: "exp-002",
    user_name: "jared",
    experiment_type: "weight_tuning",
    name: "Ensemble weight grid search",
    description: "Testing ensemble weight combinations on mock data",
    parameters: { grid_step: 0.1 },
    results: { win_rate: 0.62, sharpe_ratio: 1.05, max_drawdown: 0.18 },
    notes: "Equal weights surprisingly competitive",
    status: "completed",
    phase: "pre_server",
    data_source: "mock",
    mlflow_run_id: null,
    created_at: "2026-03-25T11:00:00Z",
    updated_at: "2026-03-25T11:10:00Z",
  },
  {
    id: "exp-003",
    user_name: "joe",
    experiment_type: "stress_test",
    name: "COVID crash regime test",
    description: "Testing model behavior during Feb-Apr 2020 crash",
    parameters: { regime: "covid_2020" },
    results: {},
    notes: null,
    status: "pending",
    phase: "pre_server",
...
export const mockProposals: import("./types").ParameterChangeProposal[] = [
  {
    id: "prop-001",
    experiment_id: "exp-001",
    parameter_name: "xgboost.max_depth",
    parameter_category: "model_hyperparam",
    current_value: 6,
    proposed_value: 5,
    metric_before: { win_rate: 0.62 },
    metric_after: { win_rate: 0.65 },
    reason: "Depth 5 shows better generalization in walk-forward validation",
    status: "joe_approved",
    requires_dual_approval: false,
    joe_approved_at: "2026-03-25T12:00:00Z",
    jared_approved_at: null,
    applied_at: null,
  ...
  },
  {
    ...
    parameter_category: "risk_constant",
    current_value: 0.12,
    proposed_value: 0.10,
    metric_before: { win_rate: 0.62, max_drawdown: 0.18 },
    metric_after: { win_rate: 0.62, max_drawdown: 0.14 },
    reason: "Reducing position size decreases drawdown with minimal win rate impact",
    status: "pending",
    requires_dual_approval: true,
    joe_approved_at: null,
    jared_approved_at: null,
    applied_at: null,
